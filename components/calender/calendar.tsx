...
const calendarData = {
    entries: [
        { date: "2023-09-23", label: "Radhashtami" },
        { date: "2023-09-26", label: "Ekadashi" },
        { date: "2023-09-26", label: "Srila Bhaktivinoda Thakura – Appearance" },
        { date: "2023-10-10", label: "Ekadashi" },
    ],
    title: "DATE DETAILS"
}
